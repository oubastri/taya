...
export const SEED_FRIENDS: Omit<FriendData, "following">[] = [
  {
    ...
    name: "Jordan Lee",
    handle: "jordan",
    bio: "Running through life one mile at a time.",
    followersCount: 47,
    phone: "+15550001234",
    avatarUrl: "/profilephotos/user1.png",
    location: "Brooklyn, NY",
    tagline: "Chasing PRs and sunrises. Every mile is a meditation.",
    prompts: [
      { question: "If I had to pick one workout for life", answer: "Long Sunday runs." },
      { question: "Currently chasing", answer: "A sub-3 hour marathon." },
      { question: "Go to post-workout meal", answer: "Acai bowl with extra granola and banana." },
      { question: "On rest days, you'll find me", answer: "Reading on a park bench with a cold brew." },
    ],
    workouts: [
  ...
  },
  {
    ...
    name: "Maya Chen",
    handle: "maya",
    bio: "Mind, body, water. Yoga & swim enthusiast.",
    followersCount: 83,
    phone: "+15550005678",
    avatarUrl: "/profilephotos/user2.png",
    location: "San Francisco",
    tagline: "Breathe deep, move slow, live fully.",
    prompts: [
      { question: "If I had to pick one workout for life", answer: "Vinyasa flow at sunrise." },
      { question: "Currently chasing", answer: "A 2km open water swim without stopping." },
      { question: "Go to post-workout meal", answer: "Smoothie bowl with mango and chia seeds." },
      { question: "On rest days, you'll find me", answer: "At a tea house journaling." },
    ],
    workouts: [
  ...
  },
  {
    ...
    name: "Sam Rodriguez",
    handle: "sam",
    bio: "Hoops + iron. Always in the gym or on the court.",
    followersCount: 61,
    phone: "+15550009012",
    avatarUrl: "/profilephotos/user3.png",
    location: "Los Angeles",
    tagline: "All day I dream about sports. Adidas, sue me.",
    prompts: [
      { question: "If I had to pick one workout for life", answer: "Pickup basketball." },
      { question: "Currently chasing", answer: "A 315 bench press." },
      { question: "Go to post-workout meal", answer: "3 eggs, chicken sausage, toast, skyr yogurt." },
      { question: "On rest days, you'll find me", answer: "Enjoying a cold beer in the sun with friends." },
    ],
    workouts: [
